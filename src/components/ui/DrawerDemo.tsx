      ...
      <Drawer>
        ...
        <DrawerContent className="p-4">
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="flex justify-between border-t-[1px] border-b-[1px] mt-4 px-4 py-4">
              ...
              <div className="flex justify-center items-center">
                <Image src="/Images/exchange.svg" alt="exchange" width={24} height={24} />
              </div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-center justify-between bg-[#FAFAFA] p-4 rounded-lg shadow-sm">
                <div className="flex items-center gap-4">
                  <Image src="/Images/Category=Cargo.svg" alt="3-Wheeler" width={32} height={32} />
                  <div>
