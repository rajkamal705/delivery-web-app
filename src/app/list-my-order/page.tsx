            ...
            <div className='flex justify-center items-center bg-gradient-to-b from-green-500 via-yellow-500 to-blue-500 min-h-screen py-10'>
                <div className='w-[90%]'>
                    ...
                    <div className='mt-4 flex gap-10'>
                        <button className='border-[2px] border-[#47Ac5F] font-[600] text-[#47AC5F] rounded-full px-20 py-4 hover:bg-[#47Ac5F] hover:text-white w-1/4'>All</button>
                        <button className='border-[2px] border-[#47Ac5F] font-[600] text-[#47AC5F] rounded-full px-20 py-4 hover:bg-[#47Ac5F] hover:text-white w-1/4'>Pending</button>
                        <button className='border-[2px] border-[#47Ac5F] font-[600] text-[#47AC5F] rounded-full px-20 py-4 hover:bg-[#47Ac5F] hover:text-white w-1/4'>On Progress</button>
                        <button className='border-[2px] border-[#47Ac5F] font-[600] text-[#47AC5F] rounded-full px-20 py-4 hover:bg-[#47Ac5F] hover:text-white w-1/4'>Delivered</button>
                    </div>
                        ...
                        <div className='bg-white rounded-2xl p-6 w-full'>
                            <div className='flex justify-between'>
                                <div className='flex gap-4'>
                                    ...
                                    <div className='flex flex-col justify-center gap-2'>
                                        <p className='font-[700] text-[20px] text-[#212121]'>SK27367279</p>
                                        <p className='text-[#616161] font-[500] text-[16px]'>Package received</p>
                                    </div>
                                </div>
                                <div className='flex items-center'>
                                    <span className='bg-[#47AC5F] text-[16px] font-[600px] px-6 py-3 rounded-lg text-[#FFFFFF]'>Completed</span>
                                </div>
                            </div>
