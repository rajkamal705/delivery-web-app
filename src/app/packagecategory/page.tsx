                ...
                <div className='w-[90%]'>
                    ...
                    <div className='flex gap-4 flex-col '>
                        ...
                        <div className='flex items-center gap-4 rounded-2xl px-10 bg-[#FAFAFA]'>
                            ...
                            <input className=' bg-[#FAFAFA] rounded-lg py-6 w-full outline-none' placeholder='Category' />
                        </div>
                    </div>
                    <div className='flex gap-4 mt-8 flex-col'>
                        <span className='text-[#212121] text-[22px] font-[700]'>Weight</span>
                        <div className='flex items-center gap-4 rounded-2xl px-10 bg-[#FAFAFA]'>
                            <input className='bg-[#FAFAFA] rounded-lg py-6 w-full outline-none' placeholder='0' />
                        </div>
                    </div>
                    ...
                    <div className='flex gap-4 mt-8 flex-col'>
                        ...
                        <div className='flex items-center gap-4 rounded-2xl px-10 bg-[#FAFAFA]'>
                            ...
                            <input className=' bg-[#FAFAFA] rounded-lg py-6 w-full outline-none' placeholder='Shipping' />
                        </div>
                    </div>
                    <div className='mt-10'>
