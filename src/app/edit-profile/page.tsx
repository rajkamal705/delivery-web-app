    ...
    return (
        <>
            <div className='flex justify-center items-center bg-gradient-to-b from-green-500 via-yellow-500 to-blue-500 min-h-screen py-10'>
                <div>
                    <h1 className='font-[700] text-[24px] text-white text-center'>Edit Profile</h1>
                    ...
                    <form className='flex flex-col gap-4 mt-10'>
                        ...
                        <Link href="/profile" className='mt-8'>
                            <button className='w-96 text-[16px] font-[700] bg-white rounded-full py-4 text-[#206ec0]'>Update</button>
                        </Link>
                    </form>
                </div>
            </div>
