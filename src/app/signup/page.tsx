        ...
        <>
            <div className='flex justify-center items-center bg-gradient-to-b from-green-500 via-yellow-500 to-blue-500 min-h-screen'>
                <div className='flex flex-col'>
                    <p className='mt-8 font-[700] text-[44px] text-center text-white'>Create your Account</p>
                    ...
                    <form className="flex flex-col items-stretch pt-3 md:pt-8">
                        ...
                        <div className="flex justify-center gap-3 mt-4">
                          ...
                          <span className='text-white flex items-center'>Remember me</span>
                        </div>
                    </form>

                    <div className='mt-8'>
                        <button className='text-[16px] font-[700] bg-white rounded-full px-52 py-4 text-[#206ec0]'>Sign up</button>
                    </div>
                    ...
                    <div className='mt-10 mb-10 flex justify-center gap-4'>
                        <span className='flex items-center text-[#9E9E9E]'>Already have an account?</span>
                        <Link href="/login">
                          <span className='text-[#47AC5F] font-[600]'>Sign in</span>
                        </Link>
                    </div>
                </div>
            </div>
